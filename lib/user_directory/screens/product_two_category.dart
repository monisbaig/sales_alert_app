...
import 'package:sales_alert_app/user_directory/screens/select_product_two.dart';

class ProductTwoCategory extends StatelessWidget {
  const ProductTwoCategory({super.key});
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  const SelectProductTwo(collection: 'Men'),
                            ),
                          );
                        },
                      ),
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  const SelectProductTwo(collection: 'Women'),
                            ),
                          );
                        },
                      ),
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  const SelectProductTwo(collection: 'Kids'),
                            ),
                          );
                        },
                      ),
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => const SelectProductTwo(
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  const SelectProductTwo(collection: 'Laptops'),
                            ),
                          );
                        },
                      ),
